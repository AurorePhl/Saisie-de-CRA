...
('2024-01-02 10:00:00', '2024-01-02 12:00:00', 'ADDED', (SELECT code FROM Assignment WHERE libelle = 'Task 1')),
('2024-01-03 11:00:00', '2024-01-03 13:00:00', 'SAVED', (SELECT code FROM Assignment WHERE libelle = 'Task 1')),
('2024-01-04 12:00:00', '2024-01-04 14:00:00', 'VALIDATED', (SELECT code FROM Assignment WHERE libelle = 'Task 1')),
('2024-01-05 13:00:00', '2024-01-05 15:00:00', 'REJECTED', (SELECT code FROM Assignment WHERE libelle = 'Task 1')),
('2024-01-06 14:00:00', '2024-01-06 16:00:00', 'SENT', (SELECT code FROM Assignment WHERE libelle = 'Task 1')),
('2024-02-02 09:00:00', '2024-02-02 11:00:00', 'ADDED', (SELECT code FROM Assignment WHERE libelle = 'Task 2')),
('2024-02-03 10:00:00', '2024-02-03 12:00:00', 'SAVED', (SELECT code FROM Assignment WHERE libelle = 'Task 2')),
('2024-02-04 11:00:00', '2024-02-04 13:00:00', 'VALIDATED', (SELECT code FROM Assignment WHERE libelle = 'Task 2')),
('2024-02-05 12:00:00', '2024-02-05 14:00:00', 'REJECTED', (SELECT code FROM Assignment WHERE libelle = 'Task 2')),
('2024-02-06 13:00:00', '2024-02-06 15:00:00', 'SENT', (SELECT code FROM Assignment WHERE libelle = 'Task 2'));
